...
// Replicated from OpenCode edit heuristics chain (commit f1ca1dec67f68e318604ada235ea6e4f3782f4b0)
...
export const PRUNE_PATTERN_REPLACERS: Replacer[] = [
  SimpleReplacer,
  LineTrimmedReplacer,
  BlockAnchorReplacer,
...
export function messageMatchesPattern(corpus: string, pattern: string): boolean {
